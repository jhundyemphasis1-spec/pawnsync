...
@section('content')
    <div
        ...
        data-index-endpoint="{{ route('admin.scrapboard-records.index') }}"
        data-store-endpoint="{{ route('admin.scrapboard-records.store') }}"
    >
        <section class="sr-card sr-card-soft p-4 mb-4 sr-data-card" style="--sr-delay: 40ms;">
            <div class="d-flex flex-column flex-lg-row justify-content-between align-items-lg-center gap-3">
                ...
                <div class="d-flex gap-2">
                    <a href="{{ route('public.index') }}" class="btn btn-sr-subtle">
        ...
        <div data-admin-stats-wrapper>
            @include('scrapboard-records.partials.stats', ['stats' => $stats])
        </div>
        ...
        <section class="sr-card p-3 p-md-4 sr-data-card" style="--sr-delay: 200ms;">
            <div class="d-flex flex-column flex-lg-row justify-content-between align-items-lg-center gap-3 mb-3">
                ...
                <span class="badge text-bg-light border" data-admin-total-badge>{{ number_format($records->total()) }} records</span>
            </div>

            <form method="GET" action="{{ route('admin.scrapboard-records.index') }}" class="sr-form-shell mb-3" data-admin-filter-form>
                <div class="row g-2 align-items-end">
                    ...
                    <div class="col-md-3 d-grid d-md-flex gap-2">
                        ...
                        <a href="{{ route('admin.scrapboard-records.index') }}" class="btn btn-sr-subtle flex-fill" data-admin-reset>Reset</a>
                    </div>
                </div>
            </form>
            ...
            <div class="sr-relative">
                ...
                <div data-admin-table-wrapper>
                    @include('scrapboard-records.partials.records-table', ['records' => $records])
                </div>
            </div>
        </section>
    </div>
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content border-0 shadow-lg" style="border-radius: 18px;">
                ...
                <div class="modal-body pt-2">
                    <form method="POST" action="{{ route('admin.scrapboard-records.store') }}" data-admin-record-form>
                        @csrf
